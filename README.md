...
This repository holds all the notes of the things I have learnt how to do. Anyone else can use it to learn the very same things. Currently, things included are:
...
5. [How to install `git`](install_git.md)
...
8. [Deployment on Docker containers](how_to_install_docker)